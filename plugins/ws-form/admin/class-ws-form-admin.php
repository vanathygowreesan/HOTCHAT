...
<?php
		...
		public function admin_menu() {
			...
			$this->hook_suffix_form_upgrade = add_submenu_page(
				...
				sprintf('<span style="color: #418FDE;">%s</span>', __('Upgrade to PRO', 'ws-form')),
				'manage_options_wsform',
			...
			$this->hook_suffix_form_add_ons = add_submenu_page(
				...
				$this->plugin_name,
				__('Add-Ons', 'ws-form'),
				sprintf('<span style="color: #418FDE;">%s</span>', __('Add-Ons', 'ws-form')),
				'manage_options_wsform',
